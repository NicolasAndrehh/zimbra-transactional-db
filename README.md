...
Asegúrate de que el servicio de MySQL esté encendido y corriendo.

Importa y ejecuta el script ubicado en la ruta bd/schema.sql. Esto creará la base de datos zimbra_db y todas sus tablas estructuradas.
...
Haz el commit y el push de esto. Quedó listo y formateado para que cualquiera que ent